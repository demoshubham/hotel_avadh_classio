                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="breadcrumb-wrap text-center">
                                <div class="breadcrumb-title">
                                    <h2 style="text-shadow:2px 2px 2px black; color: white;">Executive Room</h2>    
                                    <div class="breadcrumb-wrap">
                                        <nav aria-label="breadcrumb">
                                            <ol style="text-shadow:1px 1px 1px black" class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                                <li class="breadcrumb-item active" aria-current="page">Executive Room Details</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
            ...
            <div class="about-area5 about-p p-relative">
                <div class="container pt-120 pb-40">
                    <div class="row">
                     <!-- #right side -->
                        ...
                        <div class="sidebar-widget categories">
                            <div class="widget-content" data-aos="fade-left">
					...
					<div class="col-lg-8 col-md-12 col-sm-12 order-1">
                          ...
                          <!-- Two Column -->
                            <div class="two-column" data-aos="fade-up">
                                <div class="row">
                                     <div class="image-column col-xl-6 col-lg-12 col-md-12">
                                        <figure class="image"><img src="img/er2.jpg" alt="" style="height:490px;object-fit:cover;object-position:left;"></figure>
                                    </div>
                                    <div class="text-column col-xl-6 col-lg-12 col-md-12">
                                        <figure class="image"><img src="img/er1.jpg" alt="" style="height:230px;"></figure>
                                         <figure class="image"><img src="img/er3.jpg" alt="" style="height:230px;"></figure>
                                    </div>
                        ...
                        <div class="content-box" data-aos="fade-up">
                            ...
                            <p>Experience pure luxury in our exclusive rooms, where comfort meets style. Enjoy personalized services, stunning views, and extra comforts. We've designed every detail for your pleasure. Your stay with us is not just a visit; it's a special memory. Welcome to a place where simple meets sophisticated hospitality.</h3>
                            <ul class="room-features d-flex align-items-center">
                                <li>
                                <i class="fal fa-tv-retro"></i>43 Inch LED TV
                                </li>
                                <li>
                               ...
                               <i class="fal fa-phone-rotary"></i>Doctor On Call
                                ...
                                <li>
                                    <i class="fal fa-bed"></i> Bed Type: Twin Bed
                                </li>
                             ...
                             <h3 >Facilities</h3>
								<div data-aos="fade-up">
                                    ...
                                    <ul >
                                        ...
                                        <li>
                                            <p>Branded Toiletries,Hair Dryer ,Locker ,Complimentary breakfast Only CP AND MAP.</p>
                                        </li>
                                        <li>
