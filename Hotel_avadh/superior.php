    ...
    .breadcrumb-wrap {
        ...
        <main>
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="breadcrumb-wrap text-center">
                            <div class="breadcrumb-title">
                                <h2 style="text-shadow:2px 2px 2px black; color: white;">Superior Room </h2>    
                                <div class="breadcrumb-wrap">
                                    <nav aria-label="breadcrumb">
                                        <ol style="text-shadow:1px 1px 1px black" class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Superior Room Details</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
            ...
            <div class="about-area5 about-p p-relative">
                <div class="container pt-120 pb-40" data-aos="fade-up">
                    <div class="row">
                     <!-- #right side -->
					...
					<div class="col-lg-8 col-md-12 col-sm-12 order-1">
                            ...
                            <div class="two-column" data-aos="fade-right">
                                <div class="row">
                                     <div class="image-column col-xl-6 col-lg-12 col-md-12">
                                        <figure class="image"><img src="img/sur1.jpg" alt="" style="height:490px;object-fit:cover;object-position:left;"></figure>
                                    </div>
                                    <div class="text-column col-xl-6 col-lg-12 col-md-12">
                                        <figure class="image"><img src="img/sur2.jpg" alt="" style="height:230px;"></figure>
                                         <figure class="image"><img src="img/sur3.jpg" alt="" style="height:230px;"></figure>
                                    </div>
                        ...
                        <div class="content-box">
                            ...
                            <p>Discover comfort redefined in our superior rooms. Experience personalized service, pleasant views, and added amenities designed for your enjoyment. Your stay is not just a stopover; it's a collection of special moments. Welcome to the perfect blend of simplicity and superior hospitality in our rooms, where your comfort is our priority.</p>
                            <h3>Room Feature.</h3>
                            <ul class="room-features d-flex align-items-center">
                               ...
                               <i class="fal fa-phone-rotary"></i>Doctor On Call
                                ...
                                <li>
                                    <i class="fal fa-bed"></i> Bed Type: King Bed
                                </li>
								<li>
                             ...
                             <h3>Facilities</h3>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <p>Branded Toiletries, Complimentary breakfast Only CP AND MAP, Hair Dryers, Locker. </p>
                                    </li>
                                    <li>
