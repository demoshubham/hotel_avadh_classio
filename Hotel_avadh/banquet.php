                            ...
                            <div class="breadcrumb-wrap text-center">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Banquet Details </li>
                                    </ol>
                                </nav>
                            </div>
                                </div>
                            ...
                            <ul class="nav" id="myTab2" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#home" role="tab"
                                        aria-selected="true"><img src="img/banq1.png" alt=""> </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#profile" role="tab"
                                        aria-selected="false"><img src="img/banq2.png" alt=""></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab2" data-bs-toggle="tab" href="#profile1" role="tab"
                                        aria-selected="false"><img src="img/banq3.png" alt=""></a>
                                </li>
                            ...
                            <div class="tab-content" id="myTabContent2">
                                <div class="tab-pane fade show active" id="home" role="tabpanel">
                                    <div class="product-large-img">
                                        <img src="img/banq1.png"  alt="">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="profile" role="tabpanel">
                                    <div class="product-large-img">
                                        <img src="img/banq2.png" alt="" >
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="profile1" role="tabpanel">
                                    <div class="product-large-img">
                                        <img src="img/banq3.png" alt="" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="id-desc" role="tabpanel" aria-labelledby="desc-tab">
                                <div class="event-text mb-40">
                                    <p>You can plan events such as conferences, meetings, exhibitions, parties etc. at the “Hall 2, having 1700 Square feet pillar less air-conditioned area, best suited for conference, wedding engagements, seminars, board meets for a guest capacity of 50, and other all-day events. Catering is available for breakfast, lunch, dinner, meeting breaks and cocktail parties. Adding exquisite dishes from the cuisines of India & China. We would strive to make your experience a memorable one.The Hotel Catering service and the in-house event support team can help you arrange unforgettable events. The full-service hotel along with parking space and manpower support makes it perfect for corporate on site event and conferences.</p>
                                </div>
                            </div>
